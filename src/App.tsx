...
function AuthenticatedApp() {
  ...
  if (route.type === 'tv') {
    if (route.companyId !== profile.companyId) return <main className="access-denied" role="alert"><h1>Acesso negado</h1><p>Esta TV não pertence à empresa da sua sessão.</p></main>
